...
func main() {
	http.HandleFunc("/health", func(w http.ResponseWriter, r *http.Request) {
		json.NewEncoder(w).Encode(HealthResponse{Status: "UP", Message: "API3 is Ready", Timestamp: time.Now(), VM: "VM2", Carnet: MyCarnet})
	})
	fmt.Println("API 3 corriendo en puerto 8003...")
